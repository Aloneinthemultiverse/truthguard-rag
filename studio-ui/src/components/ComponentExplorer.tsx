...
export const COMPONENTS: Comp[] = [
  ...
  { id: 'ingest', label: 'Ingestion Pipeline', kind: 'service', layer: 'Ingestion',
    tech: ['markitdown', 'Tesseract', 'PaddleOCR', 'Mistral OCR'],
  ...
  { id: 'mistral', label: 'Mistral OCR API', kind: 'service', layer: 'Ingestion',
    tech: ['Mistral OCR', 'REST'],
    desc: 'High-tier OCR escalation for complex pages or low-confidence local results. Per-page, capped.' },
